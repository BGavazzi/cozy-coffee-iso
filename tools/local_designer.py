...
SIMULATABLE_HINT = (
    ...
    "spawn_tack, on_eaten + spawn_tick, on_feed + spawn_egg, or after_steps + "
    "move_self. Match the body "
    "to the runtime template: Egg for after_steps spawning, Toe for on_eaten "
    "spawning a Tick, Tick for on_feed spawning an Egg, and Tack for a single "
    "adjacent relocation. Do not use remove_enemy or score_line. Give it a new player-facing noun "
    ...
    "Never copy schema field names such as after_steps, on_feed, base_kind, or "
    "spawn_egg into the concept; the concept must read as a sentence a player "
    "would understand, not as instructions for filling JSON. "
